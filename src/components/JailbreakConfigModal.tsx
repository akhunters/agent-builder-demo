...
interface JailbreakConfig {
  model: string
  confidenceThreshold: number
}

interface JailbreakConfigModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: (config: JailbreakConfig) => void
  initialConfig?: JailbreakConfig
}
...
export default function JailbreakConfigModal({ isOpen, onClose, onSave, initialConfig }: JailbreakConfigModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-white/15">
          <h2 className="text-xl font-semibold text-white">Jailbreak guardrail</h2>
        ...
        <div className="px-6 py-4 border-t border-white/15 flex items-center justify-between">
          <a
            href="https://docs.composio.dev/guardrails/jailbreak"
            target="_blank"
